...
namespace ic {
    class Renderer {
        public:
            ...
            void draw_vertices(ic::Batch2D *batch, std::vector<ic::Vec2f> vertices, std::vector<ic::Color> vertexColors, const ic::Color &color = { 255, 255, 255 }); 
            void draw_vertices(ic::Batch2D *batch, std::vector<ic::Vec2f> vertices, std::vector<int> indices, std::vector<ic::Color> vertexColors, const ic::Color &color = { 255, 255, 255 }); 
            
            void draw_vertices(ic::Batch2D *batch, std::vector<ic::Vec2f> vertices, std::vector<ic::Color> vertexColors, std::vector<ic::Vec2f> vertexTexCoords, const ic::Color &color = { 255, 255, 255 }); 
            void draw_vertices(ic::Batch2D *batch, std::vector<ic::Vec2f> vertices, std::vector<int> indices, std::vector<ic::Color> vertexColors, std::vector<ic::Vec2f> vertexTexCoords, const ic::Color &color = { 255, 255, 255 }); 
