...
void ic::Physics::PositionSolver3D::solve(const std::vector<ic::Physics::Manifold3D> &manifolds) {
    for (auto &manifold : manifolds) {
        ic::Physics::Object3D *objA = manifold.object1;
        ic::Physics::Object3D *objB = manifold.object2;
...
void ic::Physics::ImpulseSolver3D::solve(const std::vector<ic::Physics::Manifold3D> &manifolds) {
    for (auto &manifold : manifolds) {
        ic::Physics::RigidObject3D *object1 = dynamic_cast<ic::Physics::RigidObject3D*>(manifold.object1);
        ic::Physics::RigidObject3D *object2 = dynamic_cast<ic::Physics::RigidObject3D*>(manifold.object2);
